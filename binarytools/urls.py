...
from .views import decimal_to_binary, string_to_binary, binary_to_decimal, decimal_to_octal, decimal_to_hexa, binary_to_octal, binary_to_hexa, hexadecimal_to_decimal, octal_to_decimal
...
urlpatterns = [
    ...
    path('octal_decimal/', octal_to_decimal, name="octal_2_decimal"),
